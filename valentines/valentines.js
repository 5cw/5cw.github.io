...
var messages = messages.map((string, i) => CryptoJS.AES.decrypt( string, password))

const message = messages.find((string) => string.toString(CryptoJS.enc.Utf8).substr(0,8) == 'VALIDATE')

const splt = message.toString(CryptoJS.enc.Utf8).substr(8).split(',')
